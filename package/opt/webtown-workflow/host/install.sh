#!/bin/bash
# docker run -it -e USER_SHELL=${SHELL} -e LOCAL_USER_ID=$(id -u) -e USER_GROUP=$(getent group docker | cut -d: -f3) -v ~/:/home/user fchris82/wf wf-install
...
# COPY binary file
cp -f /opt/webtown-workflow/host/wf_runner.sh /home/user/.webtown-workflow/bin/wf_runner.sh
...
RC_FILE=/home/user/.$(basename ${USER_SHELL:-bash})rc
if [ ! -f ${RC_FILE} ]; then
