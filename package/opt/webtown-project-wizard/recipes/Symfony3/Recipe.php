        ...
        $rootNode
            ...
            ->children()
                ...
                ->scalarNode('image')
                    ->cannotBeEmpty()
                    ->defaultNull()
                    ->info('<comment>You can set a complete new Docker image. If it is setted the program ignore the value of <info>version</info>.</comment>')
                ->end()
                ->scalarNode('env')
                ...
                ->arrayNode('environment')
                    ->info('<comment>Add environment variables.</comment>')
                    ->example(['PHP_EXTRA' => 'test'])
