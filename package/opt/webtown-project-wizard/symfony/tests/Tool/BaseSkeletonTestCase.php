...
use Tests\Dummy\Command;
use Tests\Dummy\Filesystem;
use Tests\Dummy\Input;
...
class BaseSkeletonTestCase extends TestCase
{
    ...
    protected function getTwig($path = null)
    {
        ...
        $loader->addPath($this->getBaseDir(), TwigExtendingPass::TWIG_NAMESPACE);
    ...
    {
        return __DIR__ . '/../../src/AppBundle/Resources/skeletons';
    }
}
